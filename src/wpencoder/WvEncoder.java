        ...
        while (arg_idx < args.length)
        {
            if (args[arg_idx].startsWith("-"))
            {
                ...
                else if (args[arg_idx].startsWith("-b") || args[arg_idx].startsWith("-B"))
                {
                    ...
                    if (args[arg_idx].length() > 2)	// handle the case where the string is passed in form -b0 (number beside b)
                    {
                        try
                        {
                            String substring = args[arg_idx].substring(2);
                    ...
                    else
                    {
                        ...
                        try
                        {
                        	System.out.println("Arg: " + args[arg_idx]);
                    ...
                    {
                        System.err.println("hybrid spec must be 2.0 to 16.0!: "+config.bitrate);
                        ++error_count;
                    }
                }
