...
public class WvDynamicDecoder
{
    ...
    public static void decode(InputStream input, OutputStream output)
    {
        ...
        //System.out.println("Sample Rate: " + WaveHeader.SampleRate);
        ...
        try
        {
            ...
            //output.write(myRiffChunkHeaderAsByteArray);
            //output.write(myFormatChunkHeaderAsByteArray);
            //output.write(myWaveHeaderAsByteArray);
            //output.write(myDataChunkHeaderAsByteArray);
            ...
            while (true)
            {
                ...
                if (samples_unpacked > 0)
                {
                    ...
                    output.write(pcm_buffer, 0, (int) samples_unpacked * bps);
                }
